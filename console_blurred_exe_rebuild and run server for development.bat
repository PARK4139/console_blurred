...
:: DebuggingUtil.trouble_shoot("%%%FOO%%%") 에 %%%FOO%%% 부분 autofill dev tool 적용
...
echo d | xcopy ".\$cache_database" ".\dist\console_blurred\_internal\$cache_database" /e /h /k /y
echo d | xcopy ".\$cache_log" ".\dist\console_blurred\_internal\$cache_log" /e /h /k /y
echo d | xcopy ".\$cache_mp3" ".\dist\console_blurred\_internal\$cache_mp3" /e /h /k /y
echo d | xcopy ".\$cache_png" ".\dist\console_blurred\_internal\$cache_png" /e /h /k /y
echo d | xcopy ".\$cache_tools" ".\dist\console_blurred\_internal\$cache_tools" /e /h /k /y
echo d | xcopy ".\$cache_txt" ".\dist\console_blurred\_internal\$cache_txt" /e /h /k /y
echo d | xcopy ".\pkg_yt_dlp" ".\dist\console_blurred\_internal\pkg_yt_dlp" /e /h /k /y
echo d | xcopy ".\pkg_park4139" ".\dist\console_blurred\_internal\pkg_park4139" /e /h /k /y
echo d | xcopy ".\$cache_fonts" ".\dist\console_blurred\_internal\$cache_fonts" /e /h /k /y
echo d | xcopy ".\$cache_work_for_music" ".\dist\console_blurred\_internal\$cache_work_for_music" /e /h /k /y
...
cd "%USERPROFILE%"
cd ".\Desktop\services\archive_py"
:: echo d | xcopy ".\build" "%USERPROFILE%\DESKTOP\build" /e /h /k /y
echo d | xcopy ".\dist" "%USERPROFILE%\DESKTOP\dist" /e /h /k /y
echo f | xcopy ".\console_blurred_exe_run.bat" "%USERPROFILE%\DESKTOP\dist\console_blurred_exe_run.bat" /e /h /k /y
echo f | xcopy ".\console_blurred_exe_kill.bat" "%USERPROFILE%\DESKTOP\dist\console_blurred_exe_kill.bat" /e /h /k /y
echo y | rmdir /s ".\build"
echo y | rmdir /s ".\dist"
echo y | rmdir /s ".\_internal"
